...
const PrivateMessageInput = ({ sendMessage, sendLoading }) => {
    ...
    function onSubmitMessage(currentFormState) {
        const textContent = currentFormState[FORM_FIELDS_NAME.CONTENT] || '';
        if (!textContent.trim() && !selectedFile) return;

        sendMessage(textContent, selectedFile)
            .then((res) => {
                if (res && res.ok) {
                    resetForm();
                    handleCancelFile();
            ...
            <form onSubmit={onSubmit} className="message-input-form-modern">
                ...
                <div className="message-input-action-bar">
                    ...
                    <div className="message-input-right-tools">
                        <button
                            type="submit"
                            disabled={sendLoading || (!formState[FORM_FIELDS_NAME.CONTENT].trim() && !selectedFile)}
